...
export const RegistrationStepper = ({
  ...
  return (
    <div className={cn('w-full max-w-md mx-auto', className)}>
      <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 shadow-sm">
                ...
                <li key={step.title} className="overflow-hidden">
                  <div className="flex items-start gap-4">
                    <div className="flex flex-col items-center">
                      <div className="relative flex h-8 w-8 items-center justify-center">
                        {isCompleted ? (
                          ...
                          >
                            ...
                            <span
                              className={cn(
                                'absolute text-sm font-semibold inset-0 flex items-center justify-center',
                                'text-gray-500 dark:text-gray-400',
                                isActive &&
                                  'text-white bg-blue-500 dark:bg-blue-600 rounded-full h-6 w-6 m-1'
                              )}
                            >
                              {stepNumber}
                            </span>
                      ...
                      {index < steps.length - 1 && <div className="mt-2 h-8 w-px bg-gray-200 dark:bg-gray-700" />}
                    </div>
